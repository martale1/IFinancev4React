...
def scan_market(
    ...
    def _process_row(row):
        ...
        return {
            ...
            "TECH_STRUCTURE": _clean(row.get("TECH_STRUCTURE")),
            "TECH_MOMENTUM": _clean(row.get("TECH_MOMENTUM")),
            "TECH_PARTICIPATION": _clean(row.get("TECH_PARTICIPATION")),
            "TECH_EXTENSION_PENALTY": _clean(row.get("TECH_EXTENSION_PENALTY")),
