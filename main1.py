...
#OUTPUT_FOLDER = "/home/pi/PycharmProjects/IFinancev4React/analyses/"
...
def run_gui_alerts(
    ...
    target_markets = markets or ["MIB30", "Preferite", "ETF", "ETC"]
...
markets_to_run = ['MIB30']#,'ETC','ETF','Preferite']
#,'MIB30','ETC','ETF']
# ,'US_Others']

all_results = run_markets(markets_to_run, numItems=0, generateSignalSAR_MA_S6_SK=1, generateScoring=1,generateCategory=0, liq_keep=('OK','LOW','AVOID'), print_results=True)
